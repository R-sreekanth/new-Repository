...
public class BranchForm {
	...
	public BranchForm(String name, String address, String phone_number, String pincode, String parent_organization,
			String state, String districts, String city, String email_id) {
		super();
		this.name = name;

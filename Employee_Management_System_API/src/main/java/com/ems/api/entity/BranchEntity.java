...
public class BranchEntity {
    ...
    public BranchEntity(Integer  branchId,
                        ...
                        String createdBy, LocalTime createdAt, String updateBy, LocalTime updatedAt, String status,
	...
	public String toString() {
		return "BranchEntity [branch_Id=" +  branchId + ", name=" + name + ", address=" + address + ", phone_number="
				+ phone_number + ", createdBy=" + createdBy + ", createdAt=" + createdAt + ", updateBy=" + updateBy
				+ ", updatedAt=" + updatedAt + ", status=" + status + ", parent_organization=" + parent_organization
				+ ", pincode=" + pincode + ", state=" + state + ", districts=" + districts + ", city=" + city
				+ ", email_id=" + email_id + ", createdDate=" + createdDate + ", createdTime=" + createdTime

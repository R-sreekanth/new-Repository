...
public class DepartmentServiceImpl implements DepartmentService {
	...
	@Override
	 public List<DepartmentEntity> getAllDepartments() {
        ...
        System.out.println("Departments: " + departmentEntities);

        Set<BranchEntity> branchEntities = new HashSet<>();
        Set<OrganizationEntity> organizationEntities = new HashSet<>();

        for (DepartmentEntity departmentEntity : departmentEntities) {
            if (departmentEntity.getBranch() != null) {
                branchEntities.add(departmentEntity.getBranch());
            }
            if (departmentEntity.getOrganization() != null) {
                organizationEntities.add(departmentEntity.getOrganization());
            }
        }

        // Optionally, you could convert the sets to lists if needed
        List<BranchEntity> branchEntityList = new ArrayList<>(branchEntities);
        List<OrganizationEntity> organizationEntityList = new ArrayList<>(organizationEntities);

        // Log the extracted entities
        System.out.println("Branches: " + branchEntityList);
        System.out.println("Organizations: " + organizationEntityList);
